...
if [[ "$INSTALL_CTF" == true ]]; then
    ...
    #sudo apt install -y nasm binutils-aarch64-linux-gnu binutils-mips-linux-gnu binutils-x86-64-linux-gnu binutils-arm-linux-gnueabi binutils-arm-none-eabi qemu-system
    ...
    sudo ln -s ~/ghidra_10.2.3_PUBLIC/ghidraRun /usr/local/bin/ghidra
